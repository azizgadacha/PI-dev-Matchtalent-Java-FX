...
import static services.QuizCRUD.selectQuizzes;
...
public class MainClass {
    ...
    public static void main(String[] args) {
       ...
       // creation et fonctionalités liés aux quiz
        ...
        //Quiz test = new Quiz(7,6," quiz","");
        //Quiz test=new Quiz();
        //QuizCRUD pc= new QuizCRUD();
        //test =pc.selectQuiz(6);
        //pc.updateQuiz(test);
    ...
    //List<Quiz> quizzes = selectQuizzes();
    ...
    //System.out.println(question.id_BonneReponse);}
