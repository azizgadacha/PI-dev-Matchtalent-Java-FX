...
////        p.setEtat(rs.getEtat());
            p.setIdAnnonce(new Annonce(rs.getInt("id_annonce")));
            p.setIdUtilisateur(new Utilisateur(rs.getInt("id_utilisateur")));
            p.setIdFile(new entities.File( rs.getInt("id_file")));
   ...
   public ObservableList<Postulation> getAllPostulation() throws SQLDataException {
        ...
        String requete="select * from postulation ";
         try{
            ...
            p.setIdAnnonce(new Annonce(rs.getInt("id_annonce")));
            p.setIdUtilisateur(new Utilisateur(rs.getInt("id_utilisateur")));
            p.setIdFile(new File(rs.getInt("id_file")));
            p.setDate(rs.getDate("date"));
